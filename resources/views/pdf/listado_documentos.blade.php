...
<head>
    <title>Listado General de Documentos de Camiones</title>
</head>
...
<body>
    <div class="container">
        ...
        <h1>Listado General de Documentos de Camiones</h1>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $camion->camion_pla_cam }}</td>
                    <td>{{ $camion->nom_doc_cam }}</td>
                    <td>{{ $camion->vig_doc_cam }}</td>
                    <td>{{ $camion->dias_restantes }}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
