<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('Estado') }}
            {{ Form::select('est_con', ['activo' => 'Activo', 'asignado' => 'Asignado', 'bloqueado' => 'Bloqueado', 'inactivo' => 'Inactivo'], $conductore->est_con, ['class' => 'form-control' . ($errors->has('est_con') ? ' is-invalid' : ''), 'placeholder' => 'Seleccionar estado']) }}
