<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('DNI') }}
            {{ Form::text('dni_con', $conductore->dni_con, ['class' => 'form-control' . ($errors->has('dni_con') ? ' is-invalid' : '')]) }}
        ...
        <div class="form-group">
            ...
            {{ Form::date('fec_nac_con', $conductore->fec_nac_con, ['class' => 'form-control' . ($errors->has('fec_nac_con') ? ' is-invalid' : '')]) }}
