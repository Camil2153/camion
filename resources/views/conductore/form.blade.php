<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('DNI') }}
            {{ Form::text('dni_con', $conductore->dni_con, ['class' => 'form-control' . ($errors->has('dni_con') ? ' is-invalid' : ''), 'pattern' => '[0-9]{10}', 'maxlength' => '10', 'placeholder' => 'inserte DNI sin puntos ni comas']) }}
