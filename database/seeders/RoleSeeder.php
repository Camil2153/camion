...
class RoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Permission::create(['name' => 'users.form'])->syncRoles([$role1,$role2]);
        ...
        Permission::create(['name' => 'viajes.form'])->syncRoles([$role1,$role2]);
        ...
        Permission::create(['name' => 'paises.form'])->syncRoles([$role1,$role2,$role3]);
        ...
        Permission::create(['name' => 'empresas.form'])->syncRoles([$role1,$role2,$role3]);
        ...
        Permission::create(['name' => 'conductores.form'])->syncRoles([$role1,$role2,$role3]);
        ...
        Permission::create(['name' => 'sistemas.form'])->syncRoles([$role1,$role2,$role3]);
        ...
        Permission::create(['name' => 'componentes.form'])->syncRoles([$role1,$role2,$role3]);
        ...
        Permission::create(['name' => 'ciudades.form'])->syncRoles([$role1,$role2,$role3]);
        ...
        Permission::create(['name' => 'clientes.form'])->syncRoles([$role1,$role2,$role3]);
        ...
        Permission::create(['name' => 'camiones.form'])->syncRoles([$role1,$role2,$role3]);
        ...
        Permission::create(['name' => 'tipos-servicios.form'])->syncRoles([$role1,$role2,$role3]);
        ...
        Permission::create(['name' => 'almacenes.form'])->syncRoles([$role1,$role2,$role3]);
        ...
        Permission::create(['name' => 'categorias-gastos.form'])->syncRoles([$role1,$role2,$role3]);
        ...
        Permission::create(['name' => 'rutas.form'])->syncRoles([$role1,$role2,$role3]);
        ...
        Permission::create(['name' => 'gastos.form'])->syncRoles([$role1,$role2,$role3]);
        ...
        Permission::create(['name' => 'talleres.form'])->syncRoles([$role1,$role2,$role3]);
        ...
        Permission::create(['name' => 'documentos-conductores.form'])->syncRoles([$role1,$role2,$role3]);
        ...
        Permission::create(['name' => 'servicios.form'])->syncRoles([$role1,$role2,$role3]);
        ...
        Permission::create(['name' => 'fallas.form'])->syncRoles([$role1,$role2,$role3]);
        ...
        Permission::create(['name' => 'documentos-camiones.form'])->syncRoles([$role1,$role2,$role3]);
