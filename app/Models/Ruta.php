 ...
 * @property $updated_at
 *
 * @property Ciudade $oriCiudade
 * @property Ciudade $desCiudade
 * @package App
...
class Ruta extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['cod_rut','nom_rut','ori_rut','des_rut','dis_rut','dur_rut','res_rut','com_rut','est_rut','origenCiudad','destinoCiudad'];
}